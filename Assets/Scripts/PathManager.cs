...
public class PathManager : MonoBehaviour
{
    ...
    static RetargettingManagement rmStatic;

    public Path[] paths;
    static public Path[] pathsStatic;
    ...
    static List<int> type_list = new List<int>();
    static int type = 0;

    static bool offset_6th_finger = true;
 
    static public Path generateNewPath(bool sixthFinger){
        ...
        offset_6th_finger = false;
        rmStatic.update_finger_offset_matching(offset_6th_finger);
